    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == b1) {
            try {
                ...
                rs = c.s.executeQuery("select * from meterinfoeee where meter_no = " + meter);
                ...
                rs = c.s.executeQuery("select * from billing_infoe where meter_no=" + meter + " AND month = '" + c2.getSelectedItem() + "'");

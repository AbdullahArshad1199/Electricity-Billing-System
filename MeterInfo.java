...
public class MeterInfo extends JFrame implements ActionListener {
    ...
    MeterInfo(String meter) {
        ...
        l9 = new JLabel(daysInMonth + " Days");
        ...
        l10 = new JLabel("Bill is calculated for the number of days in the current month");
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == b1) {
            ...
            // Get the current month and year again when submitting
            LocalDate currentDate = LocalDate.now();
            YearMonth yearMonth = YearMonth.of(currentDate.getYear(), currentDate.getMonth());
            int daysInMonth = yearMonth.lengthOfMonth();
            String days = String.valueOf(daysInMonth);

            try {
                Conn c = new Conn();
                String q1 = "INSERT INTO meterinfoeee (meter_no, meter_location, meter_type, phase_code, bill_type, days) VALUES ('" + meter_number + "', '" + meter_location + "', '" + meter_type + "', '" + phase_code + "', '" + bill_type + "', '" + days + "')";

...
public class NewCustomer extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == b1) {
            ...
            if (name.isEmpty() || address.isEmpty() || state.isEmpty() || city.isEmpty() || email.isEmpty() || phone.isEmpty()) {
                JOptionPane.showMessageDialog(null, "Please enter all customer details.");
            } else {
                String query1 = "INSERT INTO customer_detailss (name, meter_no, address, city, state, email, phone) VALUES (?, ?, ?, ?, ?, ?, ?)";
                try {
                    Conn c1 = new Conn();
                    PreparedStatement pst = c1.c.prepareStatement(query1);
